...
# operations DON'T REDEFINE
    ...
    def __pow__(self, other: int|float|Line):
        return Line(self.p1 ** other.p1, self.p2 ** other.p2)

    def __ipow__(self, other: int|float|Line):
        self.p1 **= other.p1
        self.p2 **= other.p2
        return self
